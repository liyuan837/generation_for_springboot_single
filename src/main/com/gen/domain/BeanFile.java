...
public class BeanFile {
    ...
    public void setImplementsClassName(String implementsClassName) {
    ...
    public String getFilePath() {
        String path =  Config.projectPath + Config.javaPath + packageName.replaceAll("\\.", "/") + "/";
        return path;
    }
    ...
    public String toString() {
        ...
        if (StringUtils.isNotBlank(implementsClassName)) {
            data.append(" implements " + implementsClassName);
        }
        data.append(" {\r\n\r\n");
